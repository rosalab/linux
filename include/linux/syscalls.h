...
asmlinkage long sys_process_set_color(int pid, u64 color);
asmlinkage long sys_process_get_color(int pid, u64 __user *ptr);
...
asmlinkage long sys_empty_syscall(void);
